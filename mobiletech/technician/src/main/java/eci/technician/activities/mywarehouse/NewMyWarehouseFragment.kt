...
class NewMyWarehouseFragment : Fragment(), ISearchableList {

    private var _binding: SearchableListBinding? = null
    private val binding
        get() = _binding!!
    private val viewModel: NewMyWarehouseViewModel by activityViewModels()
    private var fragmentToast: Toast? = null
    lateinit var adapter: TechnicianWarehouseItemAdapter
    ...
    override fun setupRecycler() {
        adapter = TechnicianWarehouseItemAdapter(this)
    ...
    override fun setupEmptyList() {
        binding.emptyListIncluded.mainText.text = getString(R.string.my_warehouse)
